...
//#cgo linux,amd64 LDFLAGS:-L${SRCDIR}/build/linux-x86_64 -lm -lrandomx -lstdc++
//#cgo linux,arm64 LDFLAGS:-L${SRCDIR}/build/linux-arm64 -lm -lrandomx -lstdc++
//#cgo darwin,amd64 LDFLAGS:-L${SRCDIR}/build/darwin-x86_64 -lm -lrandomx -lstdc++
//#cgo windows,amd64 LDFLAGS:-L${SRCDIR}/build/windows-x86_64 -lm -static-libstdc++ -static-libgcc -lrandomx
//#include <stdlib.h>
//#include "randomy.h"
import "C"
import (
